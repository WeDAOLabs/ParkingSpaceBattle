<template>
  <div class="roadmap-activations-module">
    <h2 class="gradient-color">Roadmap & Activations</h2>
    <div class="steps-content">
      <div class="steps">
        <a-steps :current="current" :direction="direction" @change="onChange" class="custom-steps">
